jQuery(document).ready(function($) {
    ...
    $('.colorpicker').each( function() {
        $(this).closest('.color-picker').find('.color').wpColorPicker();
        //$(this).farbtastic( '.' + $(this).closest('.color-picker').find('.color').attr('name') + '_class' );
        //console.log( '.' + $(this).closest('.color-picker').find('.color').attr('name') + '_class' );
    });
